...
?>
	...
	<div class="footerbgblack">
		<div class="container">		
			...
			<div class="col-md-3">
				<!--span class="ftitleblack"><?=\Yii::t("app", "General Information")?></span>
				<br/><br/>
				<ul class="footerlistblack">
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "Site usage agreement")?></a></li>
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "Privacy agreement")?></a></li>
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "Renting agreement")?></a></li>
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "Rent contract example")?></a></li>
				</ul-->
			</div>
			<!-- End of column 2-->		
			
			<div class="col-md-3">
				<!--span class="ftitleblack"><?=\Yii::t("app", "About Us")?></span>
				<br/><br/>
				<ul class="footerlistblack">
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "F.A.Q.")?></a></li>
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "About company")?></a></li>
					<li><a href="<?=Url::to('@web/')?>#"><?=\Yii::t("app", "Bank account info")?></a></li>
				</ul-->				
			</div>
			<!-- End of column 3-->		
