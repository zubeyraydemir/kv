					  ...
					  <div class="tab-pane cpadding40 active" id="profile">
						...
						<ul class="d-status">
							...
							<div class='msgbox offset-0'>
								<img src='<?=Url::to('@web/images/dash/avatar3.jpg')?>' alt='' width='30' class='left margright10 roundav'/>
							...
							<div class='msgbox2 offset-0'>
								<img src='<?=Url::to('@web/')?>images/dash/no-avatar.jpg' alt='' width='30' class='left margright10 roundav'/>
							...
							<div class='msgbox offset-0'>
								<img src='<?=Url::to('@web/')?>images/dash/avatar2.jpg' alt='' width='30' class='left margright10 roundav'/>
						...
						<div class="alert alert-warning fade in margtop20">
							...
							<strong>Notification!</strong> Best check yo self, you're not looking too good.
						</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="dbox-visitors">
									<div class="orangebox">
										<a href="#"><img src="<?=Url::to('@web/images/dash/icon-visits.png')?>" alt=""/></a>
									</div>
							...
							<div class="col-md-3">
								<div class="dbox-visitors">
									<div class="cyanbox">
										<a href="#"><img src="<?=Url::to('@web/images/dash/icon-revenue.png')?>" alt=""/></a>
									</div>
							...
							<div class="col-md-3">
								<div class="dbox-visitors">
									<div class="greenbox">
										<a href="#"><img src="<?=Url::to('@web/images/dash/icon-email.png')?>" alt=""/></a>
									</div>
							...
							<div class="col-md-3">
								<div class="dbox-visitors">
									<div class="darkbox">
										<a href="#"><img src="<?=Url::to('@web/images/dash/icon-bookings.png')?>" alt=""/></a>
									</div>
						...
						<br/>
						<span class="lato size18">Traffic</span>
						...
						<div class="bgstats">
							...
							<span class="stats">1,4,4,7,5,9,10</span>
						</div>
						...
						<div class="col-md-6 stats2container ohidden  offset-0">
							<span class="stats2"></span>
						</div>
						...
						<div class="col-md-6 offset-0">
							<span class="lato size18">8,173 people visited this site</span><br/><br/>
							<div class="col-md-12 peoplevisits offset-0">
								<div class="col-md-4">Visits<br/><span class="size18 dark">10,090</span><br/><span class="cvisits"></span></div>
								<div class="col-md-4">Unique Visitors<br/><span class="size18 dark">8,173</span><br/><span class="cvisits"></span></div>
								<div class="col-md-4">Previews<br/><span class="size18 dark">16,462</span><br/><span class="cpreview"></span></div>
								<div class="clearfix"></div><br/>
								<div class="col-md-4">Pages / Visit<br/><span class="size18 dark">1.63</span><br/><span class="cvisits2"></span></div>
								<div class="col-md-4">Avg. Visit Duration<br/><span class="size18 dark">00:01:39</span><br/><span class="cvisits2"></span></div>
								<div class="clearfix"></div>
							</div>
						</div>
								...
								<div class="col-md-6 offset-0">
									<div class="pdfix">
										...
										<div class="table-responsive">
										  <table class="table">
											<tr class="active"><td>Chrome</td><td class="textright lblue">5,633</td></tr>
											<tr class=""><td>Firefox</td><td class="textright lblue">3,274</td></tr>
											<tr class="active"><td>Safari</td><td class="textright lblue">756</td></tr>
											<tr class=""><td>Internet Explorer</td><td class="textright lblue">354</td></tr>
											<tr class="active"><td>Opera</td><td class="textright lblue">105</td></tr>
										  </table>
										</div>
										<a href="#" class="lato size12 lblue right">More info</a>
									</div>
								</div>
								<div class="col-md-6 offset-0">
									<div class="pdfix">
										...
										<div class="table-responsive">
										  <table class="table">
											<tr class="active"><td>Desktop</td><td class="textright green">10,047</td></tr>
											<tr class=""><td>Mobile</td><td class="textright green">110</td></tr>
											<tr class="active"><td>Tablet</td><td class="textright green">86</td></tr>
										  </table>
										</div>
										<a href="#" class="lato size12 lblue right">More info</a>
									</div>
						...
						<div class="col-md-12 offset-0">
										...
										<div class="table-responsive">
											<div class="fixedtopic">
												<table class="tablehover">
													<tr>
														<td><img src="<?=Url::to('@web/images/dash/no-avatar.jpg')?>" alt=""/></td>
														<td>
														<span class="dark">Load Container Content</span><br/>
														Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum et dictum urna. Donec et tortor ullamcorper, tempor ante eu, rhoncus ligula.
														</td>
														<td class="cwth"><input type="checkbox" class=""></td>
													</tr>
												</table>
												<div class="line3"></div>
												<table class="tablehover">
													<tr>
														<td><img src="<?=Url::to('@web/images/dash/no-avatar.jpg')?>" alt=""/></td>
														<td>
														<span class="dark">Customize Twitter api & add sign up/login</span><br/>
														Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum et dictum urna. Donec et tortor ullamcorper, tempor ante eu, rhoncus ligula.
														</td>
														<td class="cwth"><input type="checkbox" class=""></td>
													</tr>
												...
												<table class="tablehover">
													<tr>
														<td><img src="<?=Url::to('@web/images/dash/no-avatar.jpg')?>" alt=""/></td>
														<td>
														<span class="dark">Changing top Nav text colors</span><br/>
														Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum et dictum urna. Donec et tortor ullamcorper, tempor ante eu, rhoncus ligula.
														</td>
														<td class="cwth"><input type="checkbox" class=""></td>
													</tr>
							...
							<div class="col-md-6 cpadding01">
								...
								<span class="lato size13 grey">Disk space usage: 1,746.5 / 50,000 MB</span>
								<br/>
								<br/>
								<br/>
								<div class="progress2 progress-striped">
								...
								<span class="lato size13 grey">Monthly Bandwidth Transfer: 14,706.1 / 30.000</span>	
								<br/>
								<br/>
								<br/>						
								<div class="progress2 progress-striped">
								...
								<span class="lato size13 grey">Subdomains: 7/15</span>	
								<br/>
								<br/>
								<br/>						
								...
								<span class="lato size13 grey">All SQL Databases : 6/8</span>
								<br/>
								<br/>
								<br/>						
								<div class="progress2 progress-striped active">
								  <div class="progress-bar progress-bar-black" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%">
								  </div>
								</div>
								<span class="lato size13 grey">Email Accounts: 8 / 10</span>	
							</div>
						</div>
