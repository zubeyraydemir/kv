			...
			<div class="fullscreenbanner">
				<ul>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="<?=Url::to('@web/')?>images/slider/rome.jpg" alt=""/>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						...
						<img src="<?=Url::to('@web/')?>images/slider/paris.jpg" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
					...
					<!-- FADE -->
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="<?=Url::to('@web/')?>images/slider/santorini.jpg" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
		  ...
		  <div class="row">
			<div class="col-md-4">
				<div class="bs-example bs-example-tabs cstyle04">
					...
					<ul class="nav nav-tabs" id="myTab">
						<li onclick="mySelectUpdate()" class="active"><a data-toggle="tab" href="<?=Url::to('@web/')?>#air"><span class="flight"></span> Air</a></li>
						<li onclick="mySelectUpdate()" class=""><a data-toggle="tab" href="<?=Url::to('@web/')?>#hotel"><span class="hotel"></span>Hotel</a></li>
						<li onclick="mySelectUpdate()" class=""><a data-toggle="tab" href="<?=Url::to('@web/')?>#car"><span class="car"></span>Car</a></li>
						<li onclick="mySelectUpdate()" class=""><a data-toggle="tab" href="<?=Url::to('@web/')?>#vacations"><span class="suitcase"></span>Vacations</a></li>
					</ul>
			...
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="<?=Url::to('@web/')?>images/rome.jpg" alt="" /><div class="mhover none"><span class="icon"><a href="<?=Url::to('@web/')?>list4.html"><img src="<?=Url::to('@web/')?>images/spacer.png" alt=""/></a></span></div></div>
					<div class="ctitle">Rome<a href="<?=Url::to('@web/')?>list4.html"><img src="<?=Url::to('@web/')?>images/spacer.png" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="<?=Url::to('@web/')?>images/surfer.jpg" alt="" /><div class="mhover none"><span class="icon"><a href="<?=Url::to('@web/')?>list3.html"><img src="<?=Url::to('@web/')?>images/spacer.png" alt=""/></a></span></div></div>
					<div class="ctitle">Cote d'azur<a href="<?=Url::to('@web/')?>list3.html"><img src="<?=Url::to('@web/')?>images/spacer.png" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>			
			</div>
